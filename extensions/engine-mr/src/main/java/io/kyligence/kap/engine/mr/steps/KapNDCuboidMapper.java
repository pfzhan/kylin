...
public class KapNDCuboidMapper extends KylinMapper<Text, Text, Text, Text> {

    private static final Logger logger = LoggerFactory.getLogger(io.kyligence.kap.engine.mr.steps.KapNDCuboidMapper.class);
