...
public class CubeSegmentsTest extends LocalFileMetadataTestCase {
    ...
    public void testAppendNonPartitioned2() throws IOException {
        ...
        try {
            mgr.mergeSegments(cube, new SegmentRange.TimePartitionedSegmentRange(0L, Long.MAX_VALUE), false);
            fail();
        } catch (IllegalStateException ex) {
            // good
        }
    ...
    public void testPartitioned() throws IOException {
        ...
        try {
            mgr.mergeSegments(cube, new SegmentRange.TimePartitionedSegmentRange(500L, 2500L), true);
            fail();
