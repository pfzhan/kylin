...
public class NSnapshotTable extends RootPersistentEntity implements IReadableTable {
    ...
    public NSnapshotTable() {
    }

    NSnapshotTable(IReadableTable table, String tableName, String project) throws IOException {
    ...
    public String getResourceDir() {
        if (Strings.isNullOrEmpty(tableName)) {
            ...
            return "/" + project + ResourceStore.SNAPSHOT_RESOURCE_ROOT + "/" + tableName;
        }
    }

    private String getOldResourceDir() {
        return "/" + project + ResourceStore.SNAPSHOT_RESOURCE_ROOT + "/" + new File(signature.getPath()).getName();
    }
    ...
    public boolean equals(Object o) {
        if ((o instanceof NSnapshotTable) == false)
            return false;
        NSnapshotTable that = (NSnapshotTable) o;
