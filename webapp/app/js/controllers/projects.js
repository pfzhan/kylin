...
KylinApp
    .controller('ProjectCtrl', function ($scope,ExtFilterService, $modal, $q, ProjectService, MessageService,SweetAlert,$log,kylinConfig,projectConfig,ProjectModel,kylinCommon, AdminStoreService, VdmUtil,loadingRequest) {
