    ...
    .run([
      ...
      function ($templateCache) {
        $templateCache.put('template/treeGrid/treeGrid.html',
          ...
          "       <td data-drag=\"{{!!row.branch.drag}}\" data-jqyoui-options=\"{revert: 'invalid',helper:'clone'}\" ng-model=\"row.branch.data\" jqyoui-draggable=\"{index: {{row.branch.uid}},animate:true,deepCopy:true,placeholder:'keep'}\"><a ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\n" +
