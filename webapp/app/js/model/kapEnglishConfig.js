...
KylinApp.constant('kapEnglishConfig', {
  ...
  cube:{
    ...
    actions: 'Actions',
    schema: ['Cube Info','Dimensions','Measures','Refresh Setting','Advanced Setting','Rowtable','Configuration Overwrites','Overview'],
    admins: 'Admins',
    storage: 'Storage',
    streaming: 'Streaming',
    ...
    cubeOfRowTable: 'RowTable',
    rowtableASColumn:'Column',
    rowtableASEncoding:'Encoding',
    rowtableASIndex:'Index',
