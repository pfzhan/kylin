...
<div class="cube-info-edit">
  ...
  <ul class="list">
    <li>
      ...
      <span v-bind:style="{color: dataColor}" class="check-required">{{$t('required')}}</span>
    </li>
    <li>
      ...
      <span v-bind:style="{color: sqlColor}" class="check-required">{{$t('required')}}</span>
    </li>
  </ul>
