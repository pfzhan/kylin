<template>
  <div class="cube-manage">
      ...
      <div slot="content">
        ...
        <el-row class="row_padding">
          <el-col :span="4" class="ksd-lineheight-10" :offset="1"> {{$t('notificationEvents')}}
            <common-tip :content="$t('kylinLang.cube.noticeTip')" ><i class="el-icon-question"></i></common-tip>
          </el-col>
        </el-row>
        <el-row class="row_padding">
      ...
      <div slot="content">
        ...
        <el-row :gutter="20" class="row_padding" v-for="(timeRange, index) in timeRanges" :key="index">
          <el-col :span="4" class="ksd-lineheight-20" :offset="1">
            ...
            <el-select  v-model="timeRange.range" v-else @change="changeTimeRange(timeRange, index)">
              <el-option
          ...
          <el-col :span="2" class="ksd-lineheight-20">
            <el-button type="danger" icon="el-icon-minus" size="mini" @click.native="removeTimeRange(index)"></el-button>
          </el-col>
        </el-row>

        <el-row class="row_padding">
          <el-col class="ksd-lineheight-20" :offset="1">
            <el-button class="btn_margin ksd-mt-8"  icon="el-icon-plus" @click.native="addNewTimeRange">{{$t('newThresholds')}} </el-button>
          </el-col>
        </el-row>
      </div>
    </manageCard>
    ...
    <manageCard :title="$t('schedulerSetting')" :hasCheck=true v-on:save="checkSchedulerFrom">
      <el-checkbox v-model="isSetScheduler" slot="header" class="ksd-fright"></el-checkbox>
