...
export default {
  ...
  locales: {
    'en': {
      ...
      deleteProjectTip: 'The metadata and data of the project "{projectName}" would be deleted and couldn\'t be restored.',
    ...
    'zh-cn': {
      ...
      saveFailed: '无法添加项目。',
      deleteProjectTip: '项目 “{projectName}” 的定义及数据在删除后将会被清除, 且无法恢复。',
      projectConfig: '项目配置',
