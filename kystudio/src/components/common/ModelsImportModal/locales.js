export default {
  ...
  'zh-cn': {
    ...
    viewDetails: ' 查看导入规则',
    importTips1: '若满足以下条件时系统推荐<b>覆盖项目内同名模型</b>：与同名模型的事实表、维表、表关联关系、分区列及格式、模型加载方式、数据过滤条件完全一致。',
    ...
    replaceModelDetailsSameName: '该模型与同名模型的事实表、维表、表关联关系、分区列及格式、模型加载方式、数据过滤条件均一致。',
