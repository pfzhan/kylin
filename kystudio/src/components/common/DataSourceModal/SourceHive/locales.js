export default {
  ...
  'zh-cn': {
    ...
    refreshNow: '立即刷新',
    refreshIng: '正在刷新',
    refreshText: '无法找到想要搜索的内容？',
    refreshTips: '系统会定时缓存源表元数据。如果未找到搜索结果，可以立即刷新，或等待系统刷新完毕。',
    refreshSuccess: '数据源刷新成功',
    refreshError: '数据源无法刷新',
    noSourceData: '暂无数据源信息，请尝试刷新。<br/>请确保当前有活跃的任务节点，且您有访问源表的权限。',
    loadTableTips1_1: '当选中数据库时，',
    loadTableTips1_2: '只会加载其中未被加载过的表',
    loadTableTips1_3: '。',
    loadTableTips2_1: '可',
    loadTableTips2_2: '手动输入数据库名或表名',
    loadTableTips2_3: '，按回车键进行确认。多个名称请用逗号分隔。',
