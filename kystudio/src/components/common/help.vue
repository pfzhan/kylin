  ...
  export default {
    ...
    locales: {
      'en': {
        ...
        usernameRule: 'Username should only contain numbers, letters or underline (_)',
        ...
        noEmailStyle: 'Please enter a valid email address.',
        noCompany: 'Please enter your company name.',
        enterpriseEmail: 'Please enter a corporate email.',
        ...
        manualUrl: 'https://docs.kyligence.io/books/v4.2/en/index.html',
        ...
        manualLinkURL: 'https://docs.kyligence.io/books/v4.2/en/datasource/import_hive.en.html',
        importFailed2: ' to restart the user guide after importing the SSB sample dataset manually.'
      },
      'zh-cn': {
        autoUpload: '自动上传',
        usernameEmpty: '请输入用户名',
        usernameRule: '用户名只能包含数字，字母，或下划线（_）',
        noUserPwd: '密码不能为空',
        ...
        manualUrl: 'https://docs.kyligence.io/books/v4.2/zh-cn/index.html',
        ...
        manualLink: '手册',
        manualLinkURL: 'https://docs.kyligence.io/books/v4.2/zh-cn/datasource/import_hive.cn.html',
