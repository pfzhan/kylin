...
@Component({
  ...
  locales: {
    'en': {
      ...
      tarshTips: 'Low usage storage refers to the obsolete files generated after the system has been running for a period of time. For more details, please refer to <a href="https://docs.kyligence.io/books/v4.5/en/operation/garbage_clean.en.html" target="_blank">user manual</a>.',
      clear: 'Clear',
    ...
    'zh-cn': {
      ...
      useageMana: '已使用：',
      trash: '低效存储',
      tarshTips: '低效存储指的是系统运行一段时间后产生的垃圾文件，详情请<a href="https://docs.kyligence.io/books/v4.5/zh-cn/operation/garbage_clean.cn.html" target="_blank">查看手册</a>。',
      clear: '清除',
      resetPassword: '重置密码',
