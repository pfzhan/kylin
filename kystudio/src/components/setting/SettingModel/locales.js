export default {
  ...
  'zh-cn': {
    ...
    'isDel_kylin.engine.spark-conf.spark.executor.cores': '确认删除spark.executor.cores设置项吗？',
    'isDel_kylin.engine.spark-conf.spark.executor.instances': '确认删除spark.executor.instances设置项吗？',
    'isDel_kylin.engine.spark-conf.spark.executor.memory': '确认删除spark.executor.memory设置项吗？',
    'isDel_kylin.engine.spark-conf.spark.sql.shuffle.partitions': '确认删除spark.sql.shuffle.partitions设置项吗？',
    ...
    'spark.executor.memory': 'spark.executor.memory',
    'spark.sql.shuffle.partitions': 'spark.sql.shuffle.partitions',
    sparkCores: '单个Executor可用核心数。',
    sparkInstances: '单个Application拥有的Executor数量。',
    sparkMemory: '单个Executor最大内存。',
    sparkShuffle: '在处理join或aggregation时，shuffle数据的分区数量。'
  }
}
