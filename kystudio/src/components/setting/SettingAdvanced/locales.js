export default {
  'en': {
    ...
    exposingCCDesc: 'With this switch ON, computed columns would be exposed to the connected BI tools or others systems are connected to {type}.',
  ...
  'zh-cn': {
    ...
    exposingCC: '暴露可计算列',
    exposingCCDesc: '该选项开启后，当 BI 工具或其他系统对接 {type} 时，系统会向其暴露可计算列。',
    confirmCloseExposeCC: '若关闭该选项，当 BI 工具或其他系统对接 {type} 时，{type} 将不会向其暴露定义在 {type} 中的可计算列。该操作可能会导致此前对接 {type} 的系统无法使用。',
