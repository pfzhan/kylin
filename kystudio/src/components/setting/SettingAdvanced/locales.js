export default {
  ...
  'zh-cn': {
    ...
    openSecStorageTips: '开启后，该项目中使用的节点不可移除, 模型可按需使用分层存储。<br/><br/>分层存储暂时无法加载包含 1970 年以前数据的 parquet 文件。<a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/zh-cn/tiered_storage/" target="_blank">查看手册<i class="el-ksd-icon-spark_link_16"></i></a>',
