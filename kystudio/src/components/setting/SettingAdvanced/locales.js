export default {
  'en': {
    ...
    pleaseInputVaildEmail: 'Please enter vaild email.',
    ...
    exposingCCDesc: 'After turning on this option, when the BI or others system are connected to {type}, the system will expose computed columns to it.',
    confirmCloseExposeCC: 'If you turn off this option, when the BI or others system are connected to {type}, {type} will not expose the computed columns defined in {type} to it. This operation may make the system connected to {type} unusable.',
  ...
  'zh-cn': {
    ...
    exposingCC: '暴露可计算列',
    exposingCCDesc: '开启该选项后，当BI或其他系统对接 {type} 时，系统会向其暴露可计算列。',
    confirmCloseExposeCC: '若关闭该选项，当BI或其他系统对接 {type} 时，{type} 将不会向其暴露定义在 {type} 中的可计算列。该操作可能会导致此前对接 {type} 的系统无法使用。',
