export default {
  'en': {
    ...
    turnOff: 'Turn Off ',
    turnOnTips: 'Please note that this feature is still in BETA phase. Potential risks or known limitations might exist. Check <a class="ky-a-like" target="_blank">user manual</a> for details.<br/>Do you want to continue?',
    turnOn: 'Turn On ',
    confirmOpen: 'Turn On',
  ...
  'zh-cn': {
    ...
    turnOff: '关闭',
    turnOnTips: '请注意，此功能尚属于 BETA 阶段，可能存在潜在风险或已知限制。详情请<a class="ky-a-like" target="_blank">查看手册</a><br/>确认要开启吗？',
    turnOn: '开启',
    confirmOpen: '确认开启',
    queryFrequency: '查询频率',
    querySubmitter: '查询用户',
