export default {
  'en': {
    ...
    turnOff: 'Turn Off ',
    turnOnTips: 'Please note that this feature is still in BETA phase. Potential risks or known limitations might exist. Check <a class="ky-a-like" href="https://docs.kyligence.io/books/v4.3/en/acceleration/" target="_blank">user manual</a> for details.<br/>Do you want to continue?',
  ...
  'zh-cn': {
    ...
    turnOff: '关闭',
    turnOnTips: '请注意，此功能尚属于 BETA 阶段，可能存在潜在风险或已知限制。详情请<a class="ky-a-like" href="https://docs.kyligence.io/books/v4.3/zh-cn/acceleration/" target="_blank">查看手册</a><br/>确认要开启吗？',
