export default {
  'en': {
    ...
    jdbcShowName: 'Data Source Display Name: ',
    connectString: 'JDBC Connection String: ',
    username: 'User name: ',
    password: 'Password: ',
    modify: 'Modify',
    add: 'Add',
    modifyDatasourceConnect: 'Modify GBase Data Source Information',
    addDatasourceConnect: 'Add GBase Data Source Information',
    ...
    turnOff: 'Turn Off ',
    turnOnTips: 'Please note that this feature is still in BETA phase. Potential risks or known limitations might exist. Check <a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/en/acceleration/" target="_blank">user manual</a> for details.<br/>Do you want to continue?',
    ...
    suggestionTip2: 'recommendations for adding indexes would be generated per time. Recommendations would be updated every day by default. The frequency could be configured. Check <a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/en/acceleration/" target="_blank">user manual</a> for details.',
  ...
  'zh-cn': {
    ...
    jdbcShowName: '数据源显示名称：',
    connectString: 'JDBC 连接串：',
    username: '用户名：',
    password: '密码：',
    modify: '更改',
    add: '添加',
    modifyDatasourceConnect: '更改 GBase 数据源信息',
    addDatasourceConnect: '添加 GBase 数据源信息',
    ...
    turnOff: '关闭',
    turnOnTips: '请注意，此功能尚属于 BETA 阶段，可能存在潜在风险或已知限制。详情请<a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/zh-cn/acceleration/" target="_blank">查看手册</a><br/>确认要开启吗？',
    ...
    suggestionTip2: '条类型为新增索引的优化建议。默认每天更新一次，此更新频率可进行配置，详情请<a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/zh-cn/acceleration/" target="_blank">查看手册</a>。',
