export default {
  'en': {
    ...
    pushdownEnginDesc: 'Pushdown engine will enable analysts explore source data and then system will learn how to accelerate their queries.',
  ...
  'zh-cn': {
    ...
    pushdownEnginDesc: '开启下压查询引擎，让系统能够分析数据源数据，并且学习如何加速您的查询语句。',
