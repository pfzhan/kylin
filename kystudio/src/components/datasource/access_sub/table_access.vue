<template>
    <div class="access">
       <el-button type="primary" plain icon="el-icon-ksd-add_2" @click="addGrant" v-show="hasSomeProjectPermission || isAdmin" size="medium">{{$t('grant')}}</el-button>
       ...
       <el-table class="ksd-mt-20"
          ...
          <el-dialog :title="$t('grant')" width="720px" limited-area :visible.sync="addGrantDialog" @close="closeDialog" :close-on-press-escape="false" :close-on-click-modal="false" :append-to-body="true">
