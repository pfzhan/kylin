...
export default class subPartitionValues extends Vue {
  ...
  async confirmDropSubPartitionValues () {
    // await kapConfirm(this.$t('deleteSubPartitionValuesTip', {subSegsLength: this.selectedParValues.length}), {confirmButtonText: this.$t('kylinLang.common.delete')}, this.$t('deleteSubPartitionValuesTitle'))
    try {
