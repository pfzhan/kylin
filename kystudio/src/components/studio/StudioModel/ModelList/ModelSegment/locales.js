export default {
  'en': {
    ...
    sync: 'Sync',
    syncTips: 'Only supports syncing the online or warning segment(s) containing base table index.',
    ...
    endTime: 'End Time',
    secStorageNode: 'Secondary Storage Node',
    ...
    streaming: 'Streaming',
    syncSegmentTip: 'Sync',
    confirmSyncSegments: 'Are you sure you want to sync the following segments to the secondary storage?'
  },
  'zh-cn': {
    autoMerge: 'Auto-Merge',
    retension: 'Retension',
    ...
    secStorage: '二级存储',
    sync: '同步',
    syncTips: '仅支持同步 online 或 warning 状态且包含基础明细索引的 segment(s).',
    ...
    streaming: '实时',
    syncSegmentTip: '同步',
    confirmSyncSegments: '请确认是否将同步以下 Segment(s)中的明细索引数据导入到二级存储中？'
  }
}
