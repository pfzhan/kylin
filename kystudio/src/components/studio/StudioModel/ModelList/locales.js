export default {
  ...
  'zh-cn': {
    ...
    expansionTip: '当存储大小小于 1 GB 时，膨胀率不做显示',
    tentative: '未知',
    tentativeTips: '源表数据为空，膨胀率未知',
    ...
    modelSegmentHoleTips1: '当前批数据 Segment 区间存在空洞，此时将无法查询到该段时间的数据。',
    modelSegmentHoleTips2: '当前流数据有缺失，联系技术支持。',
    autoFix: '自动修复',
