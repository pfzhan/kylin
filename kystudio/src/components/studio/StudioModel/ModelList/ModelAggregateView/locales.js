export default {
  'en': {
    ...
    aggGroupTips: 'No aggregate group defined. Please add dimensions which would be used to answer aggregate queries in SQL in groups.',
  ...
  'zh-cn': {
    ...
    aggGroupTips: '当前无聚合组。请将需要回答SQL中的聚合查询的列按不同组合加入聚合组。',
    aggGroup: '聚合组',
