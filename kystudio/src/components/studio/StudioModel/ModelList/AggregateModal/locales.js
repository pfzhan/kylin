export default {
  'en': {
    ...
    increaseTips: '{increaseNum} index(es) would be added to model {model_name}. The new indexes could serve queries after being built. Are you sure you want to save?',
    decreaseTips: '{decreaseNum} index(es) would be deleted from model "{model_name}". The other indexes could still serve queries properly. Are you sure you want to save?',
    mixTips: '{increaseNum} index(es) would be added to model {model_name}, and {decreaseNum} index(es) would be deleted. The new indexes could serve queries after being built. The refreshed indexes could still serve queries until the new indexes are built. Are you sure you want to save?',
