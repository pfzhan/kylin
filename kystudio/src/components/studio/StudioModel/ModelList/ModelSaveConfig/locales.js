export default {
  'en': {
    ...
    forbidenComputedColumnTips: 'Computed columns are not supported at the moment. The parquet files containing data prior to 1970 cannot be loaded. <a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/en/tiered_storage/" target="_blank">View the manual <i class="el-ksd-icon-spark_link_16"></i></a>',
  ...
  'zh-cn': {
    ...
    forbidenComputedColumnTips: '暂时不支持可计算列，且无法加载包含1970年以前数据的 parquet 文件。<a class="ky-a-like" href="https://docs.kyligence.io/books/v4.5/zh-cn/tiered_storage/" target="_blank">查看手册<i class="el-ksd-icon-spark_link_16"></i></a>',
