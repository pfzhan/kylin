...
import { kapConfirm, objectClone, transToGmtTime } from '../../../../../util'
...
export default class ModelStreamingJob extends Vue {
  ...
  async stopStreaming () {
    ...
    await kapConfirm(this.$t('cofirmStopStreaming'), {confirmButtonText: this.$t('stop')}, this.$t('stopStreamingTitle'))
    try {
