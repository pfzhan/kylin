export default {
  'en': {
    ...
    delIndexesTips: 'Do you really need to delete {indexNum} indexes? After the indexes are deleted, it may affect your query performance or cause the query to fail.',
    editIndex: 'Edit',
    ID: 'ID',
    column: 'Column',
    sort: 'Order',
  ...
  'zh-cn': {
    ...
    delIndexesTips: '您确认要删除 {indexNum} 个索引？索引删除后，可能会影响您的查询性能或导致查询失败。',
    editIndex: '编辑索引',
    ID: 'ID',
    column: '列',
    sort: '顺序',
