...
<div class="model_edit_box"  @drop='drop($event)' @dragover='allowDrop($event)' :style="{width:dockerScreen.w+'px', height:dockerScreen.h+'px'}">
            ...
            <el-form label-position="top" :model="computedColumn"  ref="computedColumnForm"  :rules="computedRules" v-show="openAddComputedColumnForm">
              ...
              <el-form-item :label="$t('kylinLang.dataSource.expression')" prop="expression">
               ...
               <div v-show="computedColumn.expression">
                <el-button size="small" @click="checkExpression" :loading="checkExpressionBtnLoad">{{$t('expresscheck')}}</el-button>
    ...
    <el-dialog :title="$t('kylinLang.common.save')" v-model="addModelDialogDisable" size="small" :close-on-press-escape="false" :close-on-click-modal="false" class="saveModel">
      <partition-column :comHeight="450" :modelInfo="modelInfo" :actionMode="actionMode" :columnsForTime="timeColumns" :columnsForDate="dateColumns" :tableList="tableList" :partitionSelect="partitionSelect" :editLock="editLock" :checkModel="checkModel" :hasStreamingTable="hasStreamingTable" :showModelCheck="true"></partition-column>
      <div slot="footer" class="dialog-footer">
