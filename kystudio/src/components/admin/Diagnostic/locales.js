export default {
  'en': {
    ...
    downloadJobDiagPackage1: 'If encountered job errors, please download job diagnostic package (including this job\'s logs for Executor, Driver, and this project\'s metadata). If the job is still running, please discard it first. <br/>For other errors (i.e. query errors), please download system diagnostic package in ',
