export default {
  'en': {
    ...
    capacityTip1: 'System data volume refers to the amount of uncompressed data that has been loaded into the system and nodes used. Check manual for more details.',
    manual: 'check manual',
    cMonth: 'This Month',
