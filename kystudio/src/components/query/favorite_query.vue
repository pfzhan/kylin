  ...
  <div id="favoriteQuery">
    <div class="clearfix ksd-mb-10 ksd-mt-20 rules_tools">
      <div class="ksd-fleft ksd-mt-10">
        <span class="ksd-fs-16"><span v-html="$t('thereAre')"></span>
          <el-button type="primary" class="ksd-ml-10" plain size="medium">{{$t('accelerateNow')}}</el-button>
        </span>
      </div>
