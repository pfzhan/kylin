<template>
  <div>
    <el-dialog :title="$t('kylinLang.query.saveQuery')" :visible.sync="saveQueryFormVisible" width="720px" append-to-body  @close="closeSaveQueryDialog" :close-on-press-escape="false" :close-on-click-modal="false">
