...
exports.default = {
  ...
  capacity: {
    ...
    capacityFailTip: 'Can\'t fetch data volume used. Please try refreshing on the top bar. If problem still exists, please contact Kyligence.',
    nodesFailTip: 'Can\'t fetch nodes used. Please try refreshing on the top bar. If problem still exists, please contact Kyligence.',
    bothCapacityAndNodesFail: 'Can\'t fetch data volume used and nodes used. Please try refreshing on the top bar. If problem still exists, please contact Kyligence.'
  },
  kybotXY: {
    agreement: `
