...
exports.default = {
  ...
  capacity: {
    ...
    capacityFailTip: '已使用数据量获取失败，请尝试在顶栏刷新。若刷新后仍未恢复正常，请尽快联系 Kyligence 销售人员。',
    nodesFailTip: '已使用节点获取失败，请尝试在顶栏刷新。若刷新后仍未恢复正常，请尽快联系 Kyligence 销售人员。',
    bothCapacityAndNodesFail: '已使用数据量和节点获取失败，请尝试在顶栏刷新。若刷新后仍未恢复正常，请尽快联系 Kyligence 销售人员获取帮助。'
  },
  kybotXY: {
