...
describe('validate', () => {
  ...
  it('validate-groupname', () => {
    ...
    expect(callback.args[3][0].message).toBe(vm.$t('kylinLang.user.onlyEnglishChars'))
    validate[GROUP_NAME].bind(vm)(null, 'abc\\123', callback)
    expect(callback.args[4][0].message).toBe(vm.$t('kylinLang.user.notOtherChars'))
    validate[GROUP_NAME].bind(vm)(null, 'abc123', callback)
  ...
  it('validate-username', () => {
    ...
    expect(callback.args[9][0].message).toBe(vm.$t('kylinLang.user.onlyEnglishChars'))
    validate[USERNAME].bind(vm)(null, 'abc\\123', callback)
    expect(callback.args[10][0].message).toBe(vm.$t('kylinLang.user.notOtherChars'))
    validate[USERNAME].bind(vm)(null, 'abc123', callback)
