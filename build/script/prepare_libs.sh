...
cp extensions/storage-parquet/target/kap-storage-parquet-${kap_version}-spark.jar build/lib/kylin-storage-parquet-kap-${kap_version}.jar
...
chmod 644 build/lib/kylin-storage-parquet-kap-${kap_version}.jar
