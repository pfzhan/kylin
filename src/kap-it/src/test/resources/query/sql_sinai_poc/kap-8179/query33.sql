...
THEN 1 ELSE NULL END) = 0 THEN NULL
ELSE {fn CONVERT((CASE WHEN ("Z_360_OPPT_FINDER"."GAP_CLOSED" <> 'Yes')
...
AND ("Z_360_OPPT_FINDER"."GAP_PRIORITY" = '1')
AND ("Z_360_OPPT_FINDER"."GAP_TYPE" = 'QUALITY')
AND ("Z_360_OPPT_FINDER"."GAP_CLOSED" IN ('No', 'Yes'))
AND ("Z_360_OPPT_FINDER"."LOOKBACK_TABLE" = 'CURRENT'))
GROUP BY "Z_360_OPPT_FINDER"."GAP_NAME";