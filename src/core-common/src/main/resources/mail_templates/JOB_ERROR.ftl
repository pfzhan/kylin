...
<span style="
    ...
    <p>We found an error job happened in your kyligence system as below.</p>
    <p>It won't affect your system stability and you may repair it by following instructions.</p>
    <p>You may resume the job first. If still won't work, please send the job's diagnostic package to kyligence technical support.</p>
</span>
