...
public abstract class SecondStorageMetadataHelperTest {
    ...
    protected TableFlow getTableFlow() {
        ...
        Preconditions.checkState(
                SecondStorageUtil.tableFlowManager(getConfig(), getProject()).get().get(getModelId()).isPresent());
    ...
    protected TablePlan getTablePlan() {
        ...
        Preconditions.checkState(
                SecondStorageUtil.tablePlanManager(getConfig(), getProject()).get().get(getModelId()).isPresent());
