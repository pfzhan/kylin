        ...
        try (JdbcDatabaseContainer<?> clickhouse1 = ClickHouseUtils.startClickHouse()) {
            ...
            configClickhouseWith(clickhouse, replica, catalog, () -> {
                ...
                return lockAndUnlock(() -> {
                    ...
                    assertThrows(MsgPicker.getMsg().getProjectLocked(), KylinException.class,
                            () -> this.openSecondStorageEndpoint.recoverModel(req));
        ...
        try (JdbcDatabaseContainer<?> clickhouse1 = ClickHouseUtils.startClickHouse()) {
            ...
            configClickhouseWith(clickhouse, replica, catalog, () -> {
                ...
                return lockAndUnlock(() -> {
                    ...
                    assertThrows(MsgPicker.getMsg().getProjectLocked(), KylinException.class,
                            () -> segmentController.deleteSegments(modelId, project, true, false, null, null));
                    return null;
                });
            });
        }
