...
public class SumLCResultTest extends NLocalWithSparkSessionTest {
    ...
    public void testSumLCWithDifferentDataType() throws Exception {
        ...
        indexDataConstructor.buildIndex(dfID, new SegmentRange.TimePartitionedSegmentRange(1661961600000L, 1664553600000L),
                Sets.newHashSet(dataflow.getIndexPlan().getLayoutEntity(30001L)), true);
    ...
    public void testEmptySegment() throws Exception {
        String dfID = "f35f2937-9e4d-347a-7465-d64df939e7d6";
        NDataflow dataflow = dfMgr.getDataflow(dfID);
        indexDataConstructor.buildIndex(dfID, new SegmentRange.TimePartitionedSegmentRange(1667232000000L, 1669824000000L),
                Sets.newHashSet(dataflow.getIndexPlan().getLayoutEntity(50001L)), true);
    ...
    public void testCCQuery() throws Exception {
        ...
        indexDataConstructor.buildIndex(dfID, SegmentRange.TimePartitionedSegmentRange.createInfinite(),
                Sets.newHashSet(dataflow.getIndexPlan().getLayoutEntity(190001L)), true);
    ...
    public void testTimestampTimeCol() throws Exception {
        ...
        NDataflow dataflow = dfMgr.getDataflow(dfID);
        indexDataConstructor.buildIndex(dfID, SegmentRange.TimePartitionedSegmentRange.createInfinite(),
                Sets.newHashSet(dataflow.getIndexPlan().getLayoutEntity(1L)), true);
    ...
    public void testNullVal() throws Exception {
        ...
        indexDataConstructor.buildIndex(dfID,
                new SegmentRange.TimePartitionedSegmentRange(1667750400000L, 1667836800000L),
                Sets.newHashSet(df.getIndexPlan().getLayoutEntity(1L)), true);
